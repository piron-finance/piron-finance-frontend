  ...
  return (
    <div className="flex flex-col bg-[#007A86] p-4">
      <div className="flex items-center justify-around my-12">
        <div>
          <Image src="/footer62.svg" alt="logo" width={241} height={100} />
        </div>
            ...
            <div key={index}>
              ...
              <ul className="flex flex-col gap-2 mt-3">
                {item.links.map((link, index) => (
                  <li key={index} className="text-white font-light text-sm ">
                    {link.title}
                  </li>
                ))}
              </ul>
      ...
      <div className=" flex mx-24  border-t border-[#54A6AE]">
